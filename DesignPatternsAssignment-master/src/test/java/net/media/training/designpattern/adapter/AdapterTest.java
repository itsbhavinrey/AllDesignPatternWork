...
public class AdapterTest {
    ...
    public void testGetDisplayWallOfShame() throws Exception {
        FrontDoorRegister frontDoorRegister = new FrontDoorRegister(new ThirdPartyLeaveRecordAdapter());
    ...
    public void salaryDisbersmentTest() {
      SalaryDisberser salaryDisberser = new SalaryDisberser(new ThirdPartyLeaveRecordAdapter());
